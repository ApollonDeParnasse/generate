...
Finally this package includes two new test-runners, generate-run-tests-batch and generate-run-tests-batch-and-exit, drop in replacement for ert-run-tests-batch
...
#+end_src
** generate-run-tests-batch-and-exit
#+begin_src elisp :tangle yes
;;;###autoload
...
#+end_src
*** generate--list-of-n-sentences-base
#+begin_src emacs-lisp :tangle yes
...
#+end_src
*** generate--random-list-of-sentences-base
#+begin_src emacs-lisp :tangle yes
...
#+end_src
*** generate--random-multiline-string-base
#+begin_src emacs-lisp :tangle yes
...
#+end_src
*** generate--list-of-n-lisp-timestamp-ranges-helper
#+begin_src elisp :tangle yes
...
#+end_src
*** generate--list-of-n-unzipped-starts-ends-durations
#+begin_src elisp :tangle yes
...
** ert
*** outcomes
**** generate--random-ert-test-outcome
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--random-ert-expected-result-type
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--random-x-type-ert-test-outcome
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--list-of-n-passing-should-forms-helper
#+begin_src elisp :tangle yes
...
#+end_src
*** ert-test-result-condition
**** generate--ert-test-failed-error
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--ert-test-failed-condition-helper
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--ert-test-failed-condition
#+begin_src elisp :tangle yes
...
\(fn FAILING-SHOULD)")
#+end_src
**** generate--ert-test-skipped-condition
#+begin_src elisp :tangle yes
  ...
  (thunk-let* ((passing-should-forms (generate-random-list-of-passing-should-forms))
    ...
    (pcase outcome
      ...
      (:failed-expected (make-ert-test-failed :messages random-message
                                              ...
                                              :infos nil)))))
#+end_src
**** generate--plist-of-ert-test-result-objects
#+begin_src elisp :tangle yes
...
#+end_src
**** generate--take-from-plist-of-ert-test-results
#+begin_src elisp :tangle yes
